...
} else if(trim($comments) == 'What are your goals?') {
...
if(mail($address, $e_subject, $msg, $headers)) { echo "<fieldset><div id='success_page'><p>Thanks $name, I'll be in contact soon!</p></div></fieldset>"; }